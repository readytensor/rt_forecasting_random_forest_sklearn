...
class Forecaster:
    """Random Forest Timeseries Forecaster.

    This class provides a consistent interface that can be used with other
    Forecaster models.
    """
    MODEL_NAME = "Random_Forest_Timeseries_Forecaster"
    ...
    def save(self, model_dir_path: str) -> None:
        """Save the Random Forest forecaster to disk.
    ...
    def load(cls, model_dir_path: str) -> "Forecaster":
        """Load the Random Forest forecaster from disk.

        Args:
            model_dir_path (str): Dir path to the saved model.
        Returns:
            Forecaster: A new instance of the loaded Random Forest forecaster.
        """
