# Random Forest Forecasting Model in Scikit-Learn

This is an implementation of a Random Forest Forecasting Model in Scikit-Learn as per Ready Tensor specifications. The workflow is as follows:
...
- After this preprocessing of data into tabular format, a Random Forest model is trained on the tabular data and used to make predictions on the test data.
